  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link to="/login" className="text-green-900 hover:text-green-800 transition font-medium">Login</Link>
      ...
      <div className="min-h-screen flex flex-col md:flex-row">
        <div className="md:w-1/2 h-64 md:h-auto bg-cover bg-center" style={{backgroundImage: 'url(/login-image.png)'}}></div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-600">
                  ...
                  <Link to="/signup" className="text-green-600 hover:text-green-800 font-medium transition-colors duration-300">
                    Sign up here
                  </Link>
                </p>
              </div>
